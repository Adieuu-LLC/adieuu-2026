...
| `CF_SIGNING_PRIVATE_KEY` | PEM-encoded RSA private key for CloudFront signed URLs (media uploads + E2E media). Auto-generated and injected by Terraform when `enable_cloudfront_signed_urls = true`. |
