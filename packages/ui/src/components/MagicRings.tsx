/**
 * Animated ring effect rendered via WebGL (Three.js shader).
 *
 * Adapted from react-bits (MIT + Commons Clause)
 * @see https://reactbits.dev/animations/magic-rings
 */
...
export function MagicRings({
  ...
  return (
    <div
      ref={mountRef}
      className={`magic-rings-container${className ? ` ${className}` : ''}`}
