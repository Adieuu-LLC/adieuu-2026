...
export function LearnContent() {
  ...
  const categories = t('home.learn.categories', { returnObjects: true }) as
    | Record<string, LearnCategory>
    | string;
  ...
  const copyPermalink = useCallback(
    async (hash: string) => {
      ...
      const url = `${base}${location.pathname}#${hash}`;
      try {
    ...
    [externalLinkBase, location.pathname, t, toast],
  );
          ...
          <section key={catId} className="learn-category-group">
            ...
            >
              ...
              <button
                ...
                onClick={() => void copyPermalink(catId)}
              >
                ...
                >
                  ...
                  <Accordion.ItemContent className="learn-content-body">
                    ...
                    <button
                      ...
                      onClick={() => void copyPermalink(`${catId}-${sectionId}`)}
                    >
                      <Icon name="link" size="xs" />
