...
function makeDefaultCtx(overrides: Record<string, unknown> = {}): Record<string, unknown> {
  return {
    ...
    channels: [{ id: 'ch-1', spaceId: 'space-1', type: 'text', name: 'general', position: 0, allowedRoleIds: [] }],
    activeSpaceRoleIds: [],
    ...
    hasActiveSpacePermission: () => true,
    isActiveSpaceAdmin: true,
    activeSpacePermissions: ['manageMetadata', 'manageRoles', 'pinMessages', 'sendMessages'],
