...
interface AppearanceSectionNavProps {
  sections: AppearanceSection[];
  sectionRefs: React.RefObject<Map<string, HTMLElement>>;
}

export function AppearanceSectionNav({ sections, sectionRefs }: AppearanceSectionNavProps) {
  ...
  return (
    <>
      <nav
        className="appearance-section-nav"
        aria-label={t('identity.appearance.title')}
      >
