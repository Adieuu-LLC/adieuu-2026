...
export const call = {
  ...
  confirmJoinVoice: 'Join voice channel',
  cancelSetup: 'Cancel',
  deviceSetupHint: 'Your camera stays off until you turn it on in the call.',
  deviceSetupHintWithCamera: 'Camera preview uses your Audio & Video join defaults.',
  cameraPreviewIdle: 'Starting camera…',
