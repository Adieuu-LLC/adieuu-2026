...
export const core = {
  ...
  spaces: {
    ...
    joined: 'Joined',
    banned: 'Banned',
    bannedCannotJoin: 'You are banned from this Space',
    open: 'Open',
    encrypted: 'Encrypted',
    ...
    leaveSpace: {
      title: 'Leave Space?',
      confirm: 'You will need a new invite to rejoin this Space.',
      confirmBtn: 'Leave',
      error: 'Could not leave Space.',
    },
    favoriteAddedToast: 'Added to Favourites',
    favoriteRemovedToast: 'Removed from Favourites',
    notifications: {
      bannedTitle: 'Banned from Space',
      bannedBody: 'You were banned from {{name}}',
      bannedBodyGeneric: 'You were banned from a Space',
      kickedTitle: 'Removed from Space',
      kickedBody: 'You were removed from {{name}}',
      kickedBodyGeneric: 'You were removed from a Space',
    },
    ...
    manage: {
      ...
      banned: {
        ...
        unbanError: "Couldn't unban that member.",
      },
      audit: {
        title: 'Audit log',
        subtitle: 'Moderation and configuration changes in this Space.',
        ...
        actions: {
          ...
          member_roles_update: 'Member roles updated',
          role_create: 'Role created',
          role_update: 'Role updated',
          role_delete: 'Role deleted',
          channel_acl_update: 'Channel access updated',
          message_mod_delete: 'Message removed by moderator',
        },
      },
      danger: {
        title: 'Danger zone',
      ...
      roles: {
        ...
        settings: {
          ...
          everyoneAlwaysDefault:
            'Everyone is always assigned to every member and is the permanent default join role.',
        },
        members: {
          addLabel: 'Add member',
    ...
    permissions: {
      ...
      manageMemberRoles: {
        ...
        description: 'Allows members to assign and remove roles on other members (only roles with permissions they hold).',
      },
      manageApplications: {
    ...
    members: {
      ...
      nicknameAndColor: 'Nickname & Color',
      lastAdminRoleLocked: 'You cannot remove the Admin role while you are the only admin.',
      roleEscalationLocked: 'You cannot assign a role with permissions you do not hold.',
      adminRoleAssignLocked: 'Only system admins can assign the Admin role.',
      ...
      kickFailed: 'Could not kick member.',
      banFailed: 'Could not ban member.',
      rolesUpdateFailed: 'Could not update roles.',
      profileSaveFailed: 'Could not save member settings.',
      needsManageMemberRoles: 'You need the Manage Member Roles permission to assign roles.',
    },
    channel: {
