  ...
  identity: {
    ...
    devices: {
      ...
      export: {
        ...
        description: 'Create an encrypted backup of your device encryption keys. You will need the export password to restore this backup later.',
        ...
        success: 'Key backup exported successfully.',
        errorPasswordMismatch: 'Passwords do not match.',
        errorPasswordTooShort: 'Password must be at least {{min}} characters.',
        errorNoKeys: 'No device keys found for this identity.',
        errorFailed: 'Failed to export key backup.',
      },
      import: {
        title: 'Import Key Backup',
        description: 'Restore device encryption keys from a previously exported backup file.',
        ...
        success: 'Imported {{imported}} device key(s).',
        successWithSkipped: 'Imported {{imported}} device key(s). Skipped {{skipped}} existing.',
        mergeTitle: 'Existing Keys Found',
        mergeDescription: '{{count}} of {{total}} devices in this backup already exist on this device.',
        mergeSkip: 'Skip existing devices',
        mergeReplace: 'Replace existing devices',
        ...
        errorCorruptFile: 'The backup file is damaged or not a valid Adieuu key backup.',
        errorUnsupportedVersion: 'This backup was created with a newer version of Adieuu. Please update.',
        errorNoKeys: 'The backup file contains no device keys.',
        errorFailed: 'Failed to import key backup.',
      },
    },
    // Activity tracking
    activity: {
