...
export const en = {
  ...
  achievements: {
    ...
    mutualBlock: { name: 'He Said, She Said', description: 'Mutually block another user.' },
    blockUnblock: { name: 'On and Off Again', description: 'Block someone, then unblock them.' },
    ...
    deleteForEveryone: { name: 'Take It Back', description: 'Delete a sent message for everyone.' },
    ...
    fsMessageSent: { name: 'Burn After Reading', description: 'Send a forward-secrecy message.' },
    fsDefaultEnabled: { name: 'Forward', description: 'Enable forward secrecy as your default.' },
    fsTtlMessage: { name: "Can't Be Too Careful", description: 'Send a message with both forward secrecy and a TTL.' },
    ...
    themeSaved: { name: 'Just How I Like It', description: 'Create or edit and save a theme.' },
    ...
    notificationMaxVolume: { name: "I Can't Heeearrrr Youuuuu", description: 'Set a notification sound to 200% volume.' },
    showMessageArtifacts: { name: 'Archaeologist', description: 'Enable "Show Message Artifacts".' },
  },
} as const;
