...
/**
 * Standalone single-file upload for parallel use.
 * Unlike the hook, this carries no React state and can be called
 * concurrently for multiple files without interference.
 */
