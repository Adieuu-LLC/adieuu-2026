...
const TERMS_OF_SERVICE_SECTIONS: LegalPolicySection[] = [
  {
    ...
    content: (
      <>
        ...
        <p>
          As part of these Terms, you agree to comply with the most recent versions of our <a href='/legal-policies/privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</a>, <a href='/legal-policies/acceptable-use' target='_blank' rel='noopener noreferrer'>Acceptable Use Policy</a>, <a href='/legal-policies/paid-services' target='_blank' rel='noopener noreferrer'>Paid Services Terms</a>, and other policies (as listed <a href='/legal-policies' target='_blank' rel='noopener noreferrer'>on our Legal Policies page</a> or as otherwise made available to you), which are incorporated by reference into these Terms. If you use our services, or continue accessing or using the Services after being notified of a change to our Terms or any incorporated policies, you confirm that you have read, understand, and agree to be bound by these Terms and all incorporated policies.
        </p>
        ...
        <p>We provide our services to a global audience: as such, certain features, settings, and functionality may have different defaults, settings, or be completely unavailable depending on the local jurisdiction you connect from. We do our best to keep any of our services high-quality and accessible online, but at this time we can not make any guarantees that we will be free of interruptions or include any minimum levels of quality (which may also depend on factors beyond our control, such as the quality of your internet service and equipment).</p>
        <p>To the fullest extent permitted by law, Adieuu makes no warranties, either express or implied, about our Services. <strong>The Services are provided "as is" and "as available"</strong>. We further disclaim any implied warranties of fitness for a particular purpose, non-infringement, merchantability, and quiet enjoyment, and any warranties arising out of the course of usage or trade or dealing. Without limiting the foregoing, we do not warrant that our Services will be uninterrupted, timely, secure, or error-free, that any information or content provided through our Services (including information from third-party providers such as age verification services) will be accurate or reliable, or that our Services will be free of viruses, malware, or other harmful components. To the extent that certain jurisdictions do not allow limitations on implied warranties, and to the further extent such warranties can not be disclaimed under the laws of your jurisdiction, we limit the duration and remedies of such warranties to the full extent permissible under those laws.</p>
        <p>While we invest significantly in security measures and privacy-preserving technologies (including end-to-end encryption), no system is perfectly secure. We do not warrant or guarantee that your communications or data will remain private or that unauthorized third parties will never be able to defeat our security measures. You acknowledge that you use our Services and transmit information at your own risk.</p>
        <blockquote>
  ...
  },
  {
    ...
    title: 'Automated Systems and AI Disclosure',
    content: (
      <>
        <p>We believe in transparency about how decisions are made on our platform. This section describes how automated systems are and are not used in our Services.</p>
        <h4>Content Moderation</h4>
        <p>Adieuu does not use artificial intelligence ("AI"), machine learning models, or other automated decision-making systems in content moderation. Our content moderation processes are carried out by human reviewers. Automated scanning for child sexual abuse material ("CSAM") as described in the "Granted Licenses for E2EE Content" section uses hash-matching technology (not AI) to compare against known databases of illegal material.</p>
        <h4>Age Verification</h4>
        <p>Where required by applicable law, we use a third-party age verification provider, VerifyMy, to confirm that you meet the minimum age requirements for our Services. When you undergo age verification through VerifyMy, their processing of your data is governed by their own terms of service and privacy policy, which will be presented to you at the time of verification. Adieuu does not receive, store, or have access to any identity documents or biometric data you may submit to VerifyMy — we receive only a pass/fail verification result and the jurisdiction associated with the verification. For more information about how age verification data is handled, please see our <a href='/legal-policies/privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</a>.</p>
        <h4>No Automated Profiling or Decision-Making</h4>
        <p>We do not use AI or automated decision-making systems to profile Users, make eligibility determinations, serve targeted content, or make any decisions that produce legal or similarly significant effects concerning you. If we introduce any such systems in the future, we will update these Terms and provide appropriate notice in advance.</p>
        <blockquote>
          <p>We intentionally avoid AI in our decision-making processes. When moderation decisions are made, they're made by humans. When we verify your age, a third-party (VerifyMy) handles it and we only see the result — never your personal info (we can't even see your age!).</p>
        </blockquote>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <blockquote>
          <p>In short: if you break the rules, we'll ask you to fix it first when we can. If your actions cause us legal trouble or costs, you're responsible for those costs.</p>
        </blockquote>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h4>Export Controls and Sanctions</h4>
        <p>You agree to comply with all applicable export control and trade sanctions laws, including but not limited to the International Traffic in Arms Regulations ("ITAR"), the Export Administration Regulations ("EAR"), sanctions programs administered by the U.S. Department of the Treasury Office of Foreign Assets Control ("OFAC"), and those of any other applicable governmental authority. You represent and warrant that you are not (a) located in, organized under the laws of, or ordinarily resident in any country or territory that is the subject of comprehensive U.S. sanctions or embargoes, (b) identified on any U.S. government restricted party list (including but not limited to the Specially Designated Nationals and Blocked Persons List, the Entity List, and the Denied Persons List), or (c) otherwise prohibited from accessing or using our Services under applicable export control, trade, or sanctions laws. We reserve the right to restrict or terminate access to our Services in any manner necessary to comply with applicable export control or sanctions laws, and we are not liable to you for any such restriction or termination.</p>
        <blockquote>
          <p>In plain language: you can't use Adieuu if you're in a country or on a list that U.S. law says we can't do business with. We may block access if required by law.</p>
        </blockquote>
        <h4>Force Majeure</h4>
        <p>Neither Adieuu nor you will be liable for any failure or delay in performing an obligation under these Terms where the failure or delay results from any cause beyond the reasonable control of the affected party, including but not limited to acts of God, natural disasters, terrorism, war, riots, embargoes, acts of civil or military authorities, fire, floods, epidemics or pandemics, power outages, telecommunications failures, internet disturbances, denial-of-service attacks, or the acts or omissions of third-party service providers. The affected party will use reasonable efforts to mitigate the effect of such force majeure event and will promptly resume performance once the event has ended.</p>
        <h4>No Agency or Partnership</h4>
        <p>Nothing in these Terms, and no use of our Services (including participation in any product calls, feedback sessions, or community programs offered at any subscription tier), shall be construed to create a partnership, joint venture, agency, fiduciary, employment, or franchise relationship between you and Adieuu. You have no authority to act on behalf of Adieuu, bind Adieuu to any obligation, or represent that you have any such authority. No subscription tier (including but not limited to "Founder" or other premium tiers) confers any ownership interest, governance rights, decision-making authority, or editorial control over Adieuu, its products, its roadmap, or its business decisions.</p>
        <h4>Right to Modify or Discontinue Services</h4>
        <p>We reserve the right to modify, suspend, or discontinue any part of our Services (including any features, functionality, or content) at any time, with or without notice, and for any reason. We are not liable to you or any third party for any modification, suspension, or discontinuation of our Services or any part thereof. No subscription tier, including premium or Founder-tier subscriptions, entitles you to the continuation of any specific feature, functionality, or level of service. In the event we discontinue a material portion of our paid Services, we may, at our sole discretion, offer credits, extended access, or other remedies as we deem appropriate — but we are under no obligation to provide refunds, pro-rata or otherwise, except where required by applicable law or as otherwise described in our <a href='/legal-policies/paid-services' target='_blank' rel='noopener noreferrer'>Paid Services Terms</a>.</p>
        <h4>Beta and Experimental Features</h4>
        <p>From time to time, we may offer access to features, services, or functionality that are designated as beta, preview, experimental, early access, or similar ("Beta Features"). Beta Features are provided for evaluation purposes and may be incomplete, unstable, or subject to change or removal at any time without notice. Beta Features are provided "as is" and "as available" without any warranty of any kind. We make no commitment that Beta Features will be made generally available, and we may discontinue or materially alter any Beta Feature at our sole discretion. Your use of Beta Features is voluntary and at your own risk.</p>
        ...
        <h4>California Consumer Notice</h4>
        <p>Under California Civil Code § 1789.3, California residents are entitled to the following consumer rights notice: The Services are provided by Adieuu, LLC, located at 1617 Park Place Ave Suite 110-AD, Fort Worth, TX 76110, USA. If you have a question or complaint regarding our Services, please contact us at <a href='mailto:say@adieuu.com' target='_blank' rel='noopener noreferrer'>say@adieuu.com</a>. California residents may reach the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs by mail at 1625 North Market Blvd., Suite N 112, Sacramento, CA 95834, or by telephone at (800) 952-5210.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <blockquote>
          <p>This section defines who owns what. The short version: your content is yours. We need a license to deliver it to you and your recipients, but we don't own it. E2EE Content we literally can't read; Plaintext Content we can read and may use to improve the platform (but never sell). You're responsible for making sure anything you post is legal and doesn't infringe on others' rights.</p>
        </blockquote>
        ...
        <p>When we say "Feedback", we mean Content you submit to our Services in support tickets, feature proposals (including but not limited to our "Timeline", "Roadmap", "Vote on Features", and "Submit Feedback" functionality in our Services), through product and feature roadmap calls or Q&A sessions (including but not limited to those provided as part of services or subscriptions you pay for, such as bi-weekly calls available to Founder-tier subscribers), through comments or pull requests on our code repositories, or through interactions of any kind with Adieuu employees or contractors. By sending us Feedback, you grant us a non-exclusive, perpetual, irrevocable, transferable license to use the Feedback or any ideas generated by the Feedback without any restrictions, attribution, or compensation to you. For clarity: participating in product calls, community sessions, or any other interactive forums — regardless of your subscription tier — does not entitle you to have your Feedback implemented, does not constitute a binding commitment by Adieuu to act on your suggestions, and does not confer any ownership, equity, governance, or decision-making rights over Adieuu or its products.</p>
        ...
        <p>We believe your data belongs to you. We provide the ability to export your Account information and your Alias's Plaintext Content through the export functionality in the Adieuu app. You may request an export of your Account data at any time through your Account settings. To export Plaintext Content associated with an Alias, you must be signed into that Alias individually (due to the cryptographic separation between Accounts and Aliases, we are unable to export Alias data on your behalf). Exports are provided in a standard, machine-readable format. We will process export requests within a reasonable timeframe, and in no event later than required by applicable law.</p>
        <p>E2EE Content is encrypted with keys known only to User devices and is not stored in a format accessible to our backend systems. As such, we do not provide export functionality for E2EE Content and make no commitments regarding its portability. You are responsible for retaining any E2EE Content you wish to preserve outside of our Services.</p>
        <blockquote>
          <p>You can export your Account data and your Alias's non-encrypted content anytime. We can't export your end-to-end encrypted content for you because we can't read it — that's the whole point of E2EE.</p>
        </blockquote>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>You agree to notify us immediately (by opening a support ticket through our services, or by emailing us directly at <a href='mailto:say@adieuu.com' rel='noopener noreferrer' target='_blank'>say@adieuu.com</a>) if you believe your account has been compromised.</p>
        ...
        <p>We may offer discounts on subscriptions and purchases for enabling MFA on your Account. Specific discount amounts, eligibility, and terms are described in our <a href='/legal-policies/paid-services' target='_blank' rel='noopener noreferrer'>Paid Services Terms</a> and may change from time to time.</p>
        ...
        <h5>Electronic Communications Consent</h5>
        <p>By creating an Account, you consent to receiving electronic communications from Adieuu (including via email, push notifications, in-app messages, or other electronic means). You agree that all agreements, notices, disclosures, and other communications we provide to you electronically satisfy any legal requirement that such communications be in writing. This consent applies to transactional communications (such as account verification, security alerts, and payment receipts), service-related communications (such as feature updates, maintenance notices, and policy changes), and any other notices required under these Terms or applicable law. You may manage your notification preferences through your Account settings, though certain communications (such as security alerts and legal notices) may not be opted out of while you maintain an active Account.</p>
        <blockquote>
          <p>We'll communicate with you electronically (email, push notifications, in-app). You can control most notification preferences in settings, but we'll always be able to reach you for security alerts and legal notices.</p>
        </blockquote>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Our <a href='/legal-policies/paid-services' target='_blank' rel='noopener noreferrer'>Paid Services Terms</a> apply to any purchase you make using our supported purchase flows.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>The "Dispute Resolution" section, including the arbitration agreement and class action waiver;</li>
  ...
  },
  {
    ...
    content: (
      <>
        <blockquote>
          <p>This section limits what you can hold us financially responsible for. We're not liable for things outside our control, for other users' behavior, for data you lose by losing your own passwords, or for indirect/consequential damages. If we do owe you something, it's capped at what you've paid us in the last 12 months (or $100, whichever is more). Your statutory consumer rights still apply where the law doesn't let us limit them.</p>
        </blockquote>
        <p>
         Your consumer rights that can not be waived or limited by any contract or agreement are not affected by the provisions in this section.
        </p>
        <p>
         We do not exclude or limit our liability to you where it would be illegal for us to do so. In jurisdictions where the types of exclusions in this section are not allowed, we are only responsible to you for losses and damages that are a foreseeable result of our failure to use reasonable skill and care or our material breach of our contract with you. To the extent permitted by applicable law, our liability is limited (at our option) to the replacement, repair or resupply of the Services or the pro-rata refund to you of prepaid fees for your subscription covering the remainder of your term.
        </p>
        <p>Adieuu is not liable for the content or conduct of any Users, whether online or offline. Adieuu is not liable for any actions, omissions, or results of third-party services integrated with or accessed through our Services (including but not limited to age verification providers, payment processors, and content delivery services), nor for any claims brought against you by third parties arising out of your use of our Services.</p>
        <p>You acknowledge and agree that Adieuu has no liability for any loss of data, Content, or access resulting from your loss of passwords, encryption keys, or other credentials necessary to access your Account or Aliases. The cryptographic architecture of our Services means that certain data loss is permanent and irreversible — this is a deliberate privacy-preserving design choice, and you accept this risk by using our Services.</p>
        <p>In jurisdictions where exclusions or limitations of liability are allowed, to the maximum extent permitted by applicable law, Adieuu will in no event have any liability to you for any lost profits or revenues, loss of data or goodwill, service interruptions, computer failure or damage, or for any indirect, exemplary, special, consequential, incidental, punitive or cover damages however caused, whether in contract, tort, or under any theory of liability, and whether or not the party has been advised of the possibility of such damages. To the maximum extent permitted by applicable law, our maximum aggregate liability to you for any breach of these Terms is limited to the greater of one hundred dollars ($100) or the total amount you have paid us in subscription fees during the twelve (12) months immediately preceding the event giving rise to the claim. No disclaimers or provisions in these Terms shall limit our right to seek and obtain equitable relief.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>Before filing a formal dispute, you agree to try to resolve it informally by contacting us at <a href='mailto:legal@adieuu.com' target='_blank' rel='noopener noreferrer'>legal@adieuu.com</a> with a description of your concern. We will try to resolve the dispute informally by contacting you via email. If a dispute is not resolved within sixty (60) days of submission, you or Adieuu may bring a formal proceeding.</p>
        <h4>Binding Arbitration</h4>
        <p>You and Adieuu agree that any dispute, claim, or controversy arising out of or relating to these Terms or the breach, termination, enforcement, interpretation, or validity thereof, or to the use of the Services (collectively, "Disputes") will be resolved solely by binding, individual arbitration and not in a class, representative, or consolidated action or proceeding. You and Adieuu agree that the U.S. Federal Arbitration Act governs the interpretation and enforcement of these Terms, and that you and Adieuu are each waiving the right to a trial by jury or to participate in a class action.</p>
        <p>Arbitration will be conducted by JAMS under its then-current Streamlined Arbitration Rules and Procedures (or, if the claim exceeds $250,000, its Comprehensive Arbitration Rules). The arbitration will be conducted by a single arbitrator, in the English language, and shall take place in Tarrant County, Texas, unless you and Adieuu agree otherwise or the arbitrator determines that such a location would impose an undue burden on you, in which case the arbitration may be conducted remotely (via video or telephone conference).</p>
        <p>Payment of all filing, administration, and arbitrator fees will be governed by JAMS rules. Each party is responsible for its own costs and fees associated with arbitration, including attorney's fees, unless the arbitrator determines otherwise in accordance with applicable law.</p>
        <h4>Class Action and Jury Trial Waiver</h4>
        <p><strong>You and Adieuu agree that each may bring claims against the other only in your or its individual capacity, and not as a plaintiff or class member in any purported class or representative proceeding.</strong> Further, unless both you and Adieuu agree otherwise, the arbitrator may not consolidate more than one person's claims and may not otherwise preside over any form of a representative or class proceeding.</p>
        <h4>Exceptions to Arbitration</h4>
        <p>Notwithstanding the above, either party may seek emergency injunctive or equitable relief in any court of competent jurisdiction to prevent irreparable harm pending the appointment of an arbitrator or the arbitrator's determination of the merits. Additionally, disputes concerning intellectual property rights (including patents, copyrights, trademarks, and trade secrets) may be brought in court. Claims eligible for small claims court in your jurisdiction may also be brought in small claims court rather than arbitration.</p>
        <h4>Opt-Out</h4>
        <p>You may opt out of this arbitration agreement by sending written notice to <a href='mailto:legal@adieuu.com' target='_blank' rel='noopener noreferrer'>legal@adieuu.com</a> within thirty (30) days of first accepting these Terms. Your notice must include your name, Account email address, and a clear statement that you wish to opt out of binding arbitration. If you opt out, you and Adieuu will resolve Disputes under the "Governing Law; Venue; Fees" provisions in the General Provisions section of these Terms.</p>
        <blockquote>
          <p>We include an arbitration clause because it tends to result in faster, cheaper resolution for both parties. However, we believe you should have a choice: you have 30 days to opt out if you prefer to retain your right to go to court.</p>
        </blockquote>
      </>
    ),
  },
  {
    id: 'dmca-counter-notification',
    title: 'DMCA Policy and Counter-Notification',
    content: (
      <>
        <blockquote>
          <p>If someone copies your work and posts it on Adieuu, you can file a DMCA takedown notice. If your content was wrongly removed, you can file a counter-notification to get it restored. This section explains both processes step by step.</p>
        </blockquote>
        <p>Adieuu respects the intellectual property rights of others and expects Users of our Services to do the same. We respond to notices of alleged copyright infringement that comply with the Digital Millennium Copyright Act ("DMCA"), 17 U.S.C. § 512.</p>
        <h4>Filing a DMCA Takedown Notice</h4>
        <p>If you believe that your copyrighted work has been copied in a way that constitutes copyright infringement and is accessible on our Services, you may notify our designated copyright agent. Your notice must include:</p>
        <ul>
          <li>A physical or electronic signature of the copyright owner or a person authorized to act on their behalf;</li>
          <li>Identification of the copyrighted work claimed to have been infringed;</li>
          <li>Identification of the material that is claimed to be infringing or to be the subject of infringing activity, and information reasonably sufficient to permit us to locate the material (such as a URL or other specific reference);</li>
        ...
        <p>DMCA notices must be sent to <a href='mailto:dmca@adieuu.com' target='_blank' rel='noopener noreferrer'>dmca@adieuu.com</a>.</p>
        <h4>Counter-Notification Process</h4>
        <p>If you believe that your Content was removed or disabled by mistake or misidentification, you may submit a counter-notification to us at <a href='mailto:dmca@adieuu.com' target='_blank' rel='noopener noreferrer'>dmca@adieuu.com</a>. Your counter-notification must include:</p>
        <ul>
          ...
          <li>A statement that you consent to the jurisdiction of the federal courts in the Northern District of Texas and that you will accept service of process from the person who provided the original DMCA notification or an agent of such person.</li>
        </ul>
        <p>Upon receipt of a valid counter-notification, we will promptly forward a copy to the party who filed the original notice. If the original complainant does not file a court action seeking to restrain the allegedly infringing activity within ten (10) business days of receiving the counter-notification, we will restore the removed material or cease disabling access to it within ten (10) to fourteen (14) business days.</p>
        <h4>Repeat Infringers</h4>
        <p>In accordance with the DMCA and other applicable law, we have adopted a policy of terminating, in appropriate circumstances and at our sole discretion, Aliases that are deemed to be repeat infringers. We may also, at our sole discretion, limit access to our Services or terminate any Alias that infringes the intellectual property rights of others, whether or not there is any repeat infringement.</p>
        <h4>Designated Copyright Agent</h4>
        <p>Our designated agent for notice of alleged copyright infringement can be reached at:</p>
        <p>Adieuu, LLC<br />Attn: DMCA Agent<br />1617 Park Place Ave Suite 110-AD<br />Fort Worth, TX 76110, USA<br />Email: <a href='mailto:dmca@adieuu.com' target='_blank' rel='noopener noreferrer'>dmca@adieuu.com</a></p>
      </>
    ),
  },
];
