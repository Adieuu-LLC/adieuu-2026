...
export {
  ...
  type EncryptedSpaceDescription,
  type SpaceSeedRoleSystem,
  ...
  type SpaceMessageRevision,
  type PublicSpaceReaction,
  type SpaceViewerPermissions,
  type SpaceManageRecentJoin,
  type SpaceManageOverview,
...
export {
  ...
  type ChatSpaceCreatedMessage,
  type ChatSpaceUpdatedMessage,
  type ChatSpaceDeletedMessage,
  type ChatSpaceMessageMessage,
  type ChatSpaceMemberJoinedMessage,
  type ChatSpaceMemberLeftMessage,
  type ChatSpaceInviteReceivedMessage,
  type ChatSpaceInviteAcceptedMessage,
  type ChatSpaceInviteRevokedMessage,
