...
; customHeader is inserted by app-builder *after* multiUser.nsh, so $installMode
; (declared by Var installMode in multiUser.nsh) is already known to the parser
; here. Defining these Functions at top level instead causes NSIS warning 6000
