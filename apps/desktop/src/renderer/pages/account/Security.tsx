...
function parseUserAgent(userAgent?: string): string {
  ...
  if (userAgent.includes('Electron')) {
    if (userAgent.includes('Windows')) return 'Chadder Desktop (Windows)';
    if (userAgent.includes('Mac')) return 'Chadder Desktop (macOS)';
    if (userAgent.includes('Linux')) return 'Chadder Desktop (Linux)';
    return 'Chadder Desktop';
  }
