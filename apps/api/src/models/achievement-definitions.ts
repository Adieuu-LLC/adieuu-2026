...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  {
    id: 'mclovin',
    name: 'achievements.hawaiianOrganDonor.name',
    description: 'achievements.hawaiianOrganDonor.description',
    icon: 'kidneys',
    category: 'profile',
  ...
  },
  {
    ...
    name: 'achievements.caughtInTheRain.name',
    description: 'achievements.caughtInTheRain.description',
    icon: 'coconut',
    category: 'profile',
  ...
  {
    id: 'silent_bob',
    name: 'achievements.strongSilentType.name',
    description: 'achievements.strongSilentType.description',
    icon: 'ellipsis',
    category: 'profile',
  ...
  {
    id: 'regina_george',
    name: 'achievements.cantSitWithUs.name',
    description: 'achievements.cantSitWithUs.description',
    icon: 'crown',
    category: 'misc',
  ...
  },
  {
    ...
    name: 'achievements.corkboardMethod.name',
    description: 'achievements.corkboardMethod.description',
    icon: 'pin',
    category: 'profile',
  ...
  },
  {
    ...
    name: 'achievements.jesusChrist.name',
    description: 'achievements.jesusChrist.description',
    icon: 'eye',
    category: 'misc',
  ...
  },
  {
    ...
    name: 'achievements.holidayMashup.name',
    description: 'achievements.holidayMashup.description',
    icon: 'gift',
    category: 'profile',
  ...
  },
  {
    ...
    name: 'achievements.dinerRegular.name',
    description: 'achievements.dinerRegular.description',
    icon: 'mugSaucer',
    category: 'misc',
  ...
  },
  {
    ...
    name: 'achievements.inOmniaParatus.name',
    description: 'achievements.inOmniaParatus.description',
    icon: 'parachuteBox',
    category: 'misc',
  ...
  {
    id: 'satriales_vip',
    name: 'achievements.porkStoreVip.name',
    description: 'achievements.porkStoreVip.description',
    icon: 'pizzaSlice',
    category: 'misc',
  ...
  {
    id: 'the_dundie_award',
    name: 'achievements.theAnnualAward.name',
    description: 'achievements.theAnnualAward.description',
    icon: 'trophy',
    category: 'misc',
  ...
  {
    id: 'what_are_you',
    name: 'achievements.whatAreYou.name',
    description: 'achievements.whatAreYou.description',
    icon: 'hatChef',
    category: 'misc',
    trigger: { type: 'action', action: 'text_idiot_sandwich' },
  },
  {
    id: 'its_raw',
    name: 'achievements.itsRaw.name',
    description: 'achievements.itsRaw.description',
    icon: 'temperatureFull',
    category: 'misc',
    trigger: { type: 'action', action: 'text_lamb_sauce' },
  },
  {
    id: 'welcome_mayors_office',
    name: 'achievements.welcomeMayorsOffice.name',
    description: 'achievements.welcomeMayorsOffice.description',
    icon: 'landmark',
    category: 'profile',
    trigger: { type: 'action', action: 'bio_flavortown' },
  },
  {
    id: 'house_stark',
    name: 'achievements.theNorthRemembers.name',
    description: 'achievements.theNorthRemembers.description',
    icon: 'snowflake',
    category: 'misc',
    trigger: { type: 'action', action: 'text_winter_is_coming' },
  },
  {
    id: 'mother_of_dragons',
    name: 'achievements.breakerOfChains.name',
    description: 'achievements.breakerOfChains.description',
    icon: 'dragon',
    category: 'profile',
    trigger: { type: 'action', action: 'display_name_khaleesi_daenerys' },
  },
  {
    id: 'god_of_death',
    name: 'achievements.notToday.name',
    description: 'achievements.notToday.description',
    icon: 'skull',
    category: 'profile',
    trigger: { type: 'action', action: 'bio_not_today' },
  },
  {
    id: 'hand_of_king',
    name: 'achievements.theRightHand.name',
    description: 'achievements.theRightHand.description',
    icon: 'wineGlass',
    category: 'profile',
    trigger: { type: 'action', action: 'bio_drink_and_know_things' },
  },
  {
    id: 'eat_the_food_tina',
    name: 'achievements.eatTheFood.name',
    description: 'achievements.eatTheFood.description',
    icon: 'utensils',
    category: 'misc',
    trigger: { type: 'action', action: 'text_you_fat_lard' },
  },
  {
    id: 'stay_classy',
    name: 'achievements.stayClassy.name',
    description: 'achievements.stayClassy.description',
    icon: 'lamp',
    category: 'misc',
    trigger: { type: 'action', action: 'text_glass_case_of_emotion' },
  },
  {
    id: 'freakin_idiot',
    name: 'achievements.freakinIdiot.name',
    description: 'achievements.freakinIdiot.description',
    icon: 'boxBallot',
    category: 'profile',
    trigger: { type: 'action', action: 'bio_vote_for_pedro' },
  },
  {
    id: 'ouch_charlie',
    name: 'achievements.ouchCharlie.name',
    description: 'achievements.ouchCharlie.description',
    icon: 'tooth',
    category: 'profile',
    trigger: { type: 'action', action: 'bio_charlie_bit_me' },
  },
  {
    id: 'cold_pop',
    name: 'achievements.coldPop.name',
    description: 'achievements.coldPop.description',
    icon: 'bottleWater',
    category: 'profile',
    trigger: { type: 'action', action: 'bio_aint_nobody_got_time' },
  },
  {
    id: 'no_this_is_patrick',
    name: 'achievements.noThisIsPatrick.name',
    description: 'achievements.noThisIsPatrick.description',
    icon: 'crab',
    category: 'profile',
    trigger: { type: 'action', action: 'display_name_krusty_krab' },
  },
  {
    id: 'earth_kingdom',
    name: 'achievements.earthKingdom.name',
    description: 'achievements.earthKingdom.description',
    icon: 'leaf',
    category: 'profile',
  ...
  {
    id: 'ow_my_balls',
    name: 'achievements.owMy.name',
    description: 'achievements.owMy.description',
    icon: 'film',
    category: 'misc',
  ...
  {
    id: 'carls_jr',
    name: 'achievements.welcomeToTheFuture.name',
    description: 'achievements.welcomeToTheFuture.description',
    icon: 'utensils',
    category: 'misc',
  ...
  {
    id: 'walk_into_mordor',
    name: 'achievements.oneDoesNotSimply.name',
    description: 'achievements.oneDoesNotSimply.description',
    icon: 'shield',
    category: 'messaging',
  ...
  {
    id: 'hi_bob',
    name: 'achievements.hiBob.name',
    description: 'achievements.hiBob.description',
    icon: 'hand',
    category: 'messaging',
    trigger: { type: 'action', action: 'hi_bob_sent' },
  },
  {
    id: 'the_can_opener',
    name: 'achievements.theCanOpener.name',
    description: 'achievements.theCanOpener.description',
    icon: 'briefcase',
    category: 'messaging',
    trigger: { type: 'action', action: 'text_can_opener' },
  },
  {
    id: 'its_not_bragging',
    name: 'achievements.itsNotBragging.name',
    description: 'achievements.itsNotBragging.description',
    icon: 'star',
    category: 'messaging',
    trigger: { type: 'action', action: 'text_not_bragging' },
  },
